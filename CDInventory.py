...
strFileName = '/Users/mariakot/Desktop/Python UW/Assignments/Assignment06/CDInventory.txt'  # data storage file
...
while True:
    ...
    # 3.3 process add a CD
        ...
        ID1, Title1, Artist1 = IO.add_data()
        # 3.3.2 Add item to the table
        # TODone move processing code into function
        DataProcessor.newCD_processing(ID1, Title1, Artist1, lstTbl)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
